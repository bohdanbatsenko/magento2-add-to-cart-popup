define([
    ...
    $.widget('namespace.widgetName', {
        ...
        addHandlers() {
            this._on(document, {
                'ajax:addToCart': this.subscribeToCartSection.bind(this)
            });
        },

        subscribeToCartSection() {
            this.cart = customerData.get('cart').subscribe(this.callPopup.bind(this));
        },
        ...
        callPopup(cart){
            ...
            this.cart.dispose(); // kill section subscription
        },
